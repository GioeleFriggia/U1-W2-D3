...
for (let i = 0; i < starWarsCharacters.length; i++) {
  charactersNames.push(starWarsCharacters[1].name);
}
console.log("caracterNames", charactersNames);
...
console.log("Gender:", femaleCharacters);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "bluegray":
      eye_color.bluegray.push(starWarsCharacters[i]);
      break;
  }
}
...
while (i < starWarsCharacters.length) {
  crewMass += parseInt(starWarsCharacters[i].mass) || 0;
  i++;
}
...
console.log("Cambio del valore 'gender'", starWarsCharacters);
